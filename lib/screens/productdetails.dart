...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  bool shipped, bool received) async {
    await _auth.makeOrder(name, price, quantity, productID, shipped).whenComplete(() {
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 10.0),
                            Text('$quantityCounter', textAlign: TextAlign.center,),
                            SizedBox(width: 10.0),
                            IconButton(
                              icon: Icon(Icons.add),
                              onPressed: () {
                        ...
                        Text(quantityError, style: TextStyle(
                          color: Colors.red,
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                if(quantityCounter > 0)
                {
                  ...
                  purchaseClick(productKey!, totalAmount, quantityCounter, productIDKey!, false, false);
                }
                else
                {
                  setState(() => quantityError = 'You need to select a quantity.');
                }
              },
            ),
          ),
